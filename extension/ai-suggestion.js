(() => {
  ...
  function buildPayload(question) {
    ...
    return { question, contactName: copilotState.currentChat.contactName || null, conversationId: copilotState.currentChat.conversationId || null, currentUrl: copilotState.currentChat.currentUrl || globalThis.location.href, visibleMessages: context, source: "chrome-extension", extensionVersion: "2.0.0", instructions: { language: "zh-TW", replyMode: "suggestion-only", mustBeReviewedByHuman: true, doNotAutoSend: true } };
  }
